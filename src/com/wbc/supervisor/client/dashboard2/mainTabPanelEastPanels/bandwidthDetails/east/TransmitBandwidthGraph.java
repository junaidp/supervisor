 ...
 */
public class TransmitBandwidthGraph extends FlowPanel {
    ...
    public TransmitBandwidthGraph(){
        add(new HTML("Transmit Bandwidth Graph"));
//        addStyleName("intravueDark");
        layout();
    }
...
//            if(browserHalfWidth >= DashboardConstants.TAB_SIZE) {
