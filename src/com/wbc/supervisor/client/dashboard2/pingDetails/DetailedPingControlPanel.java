 ...
 */
public class DetailedPingControlPanel extends VerticalPanel {
    ...
    public DetailedPingControlPanel() {
        ...
        updateScrollPanelSize(scroll);
        add(scroll);
        setHandlers();
//        getMachineIpAddress();
        sessionExpires = new Date(System.currentTimeMillis() + DashboardConstants.SESSION_DURATION);
//        ipAddress = (String) Cookies.getCookie("ip");
    ...
    private void updateScrollPanelSize(ScrollPanel scroll) {
        scroll.setHeight(Window.getClientHeight() - 255 + "px");
    }
